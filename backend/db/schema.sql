...
-- ----------------------------------------------------------------------------------
-- 1. Users Table
-- Stores user account informaiton
-- ----------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------
-- 2. Questions Table
-- Stores the main question posted by users.
-- Supports full-text search on title and content for exact match searche.
-- ----------------------------------------------------------------------------------
...
COLLATE=utf8mb4_unicode_ci;
-- ----------------------------------------------------------------------------------
-- 5 RAG: user-owned PDF documents, text chunks, and embeddings
-- 5.1 documents table to store uploaded PDF metadata
-- ----------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------
-- 5.2 document_chunks tables to store text chunks
-- ----------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------
-- 5.3 document_chunk_vectors tables to store text embeddings
-- ----------------------------------------------------------------------------------
